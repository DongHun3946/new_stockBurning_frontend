...
export default {
  ...
  methods: {
    async checkCurrentPassword(){
      try {
        const response = await axios.post("https://www.stockburning.shop/api/modify/check-password", {
    ...
    async submitRegistration() {
      ...
      try {
        const response = await axios.put(`https://www.stockburning.shop/api/modify/password`, {
          userid : this.$store.getters.userId,
