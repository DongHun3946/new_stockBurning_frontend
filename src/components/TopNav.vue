  ...
  <div class="navbar">
    ...
    <div class="navbar-right">
      ...
      <div class="userInfo" v-show="this.$store.getters.isLoggedIn">
        <span class="divider-line">I</span>
...
export default {
  ...
  computed: {
    userImageSrc(){
      return this.$store.getters.userImage !== "default_img" ? this.$store.getters.userImage : "/imgs/profile_32.png";
    }
  },
  methods: {
    settingClick() {
...
.userInfo {
  display: flex;
  flex-direction: row;
  /* background-color: rgb(219, 62, 41); */
}

.divider-line {
  color: gray;
  /* background-color: #bec743; */
}

.user-image {
  margin-left: 15px;
  /* background-color: rgb(194, 127, 52); */
}
.user-image img {
  width: 25px !important;  /* 크기 강제 지정 */
  height: 25px !important;
  border-radius: 30%;
  object-fit: cover;
  display: block;
  box-shadow: 3px 5px 10px rgba(0, 0, 0, 0.3); /* 그림자 추가 */
}
.user-id {
